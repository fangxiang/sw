...
self.addEventListener('fetch', function(event) {
  ...
  console.log(event.request.method+'  '+event.request.headers.get('accept'));
  console.log((event.request.method === 'GET')+'  '+(event.request.headers.get('accept').includes('text/html')));
